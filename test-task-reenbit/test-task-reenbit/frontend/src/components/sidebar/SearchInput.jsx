  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center max-w-sm mx-auto">   
      ...
      <div className="relative w-full">
        ...
        <input type="text" id="simple-search" className="pl-5 bg-gray-800 text-white text-sm rounded-3xl block w-full p-2.5" placeholder="Search..." value={search} onChange={(e) => setSearch(e.target.value)}required />
      </div>
